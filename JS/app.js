...
function initWelcome() {
  const dontShow = localStorage.getItem('digimaster_welcome_seen') === 'true';
  const overlay  = document.getElementById('welcomeOverlay');
  if (!overlay) return;
  if (dontShow) overlay.classList.remove('open');
...
window.saveDontShow = function(checked) {
  localStorage.setItem('digimaster_welcome_seen', checked ? 'true' : 'false');
};
