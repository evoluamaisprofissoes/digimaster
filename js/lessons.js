    ...
    lessons: [
      {
        ...
        num: 0,
        icon: '🏠',
        title: 'Introdução — Posição Home',
        desc: 'Antes de tudo: conheça a posição base. Dedos da mão esquerda em ASDF e direita em JKL. Esta é a fundação de tudo.',
        keys: ['a','s','d','f','j','k','l'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'aaa sss ddd fff jjj kkk lll aaa jjj sss kkk ddd lll fff jjj asdf jkl fdsa lkj asdf jkl',
        xp: 30,
        tip: 'Sinta as marcas nas teclas F e J sem olhar. Elas são seu ponto de referência sempre.',
        isIntro: true
      },
      {
        id: 'b1',
        num: 1,
        icon: '✋',
        title: 'Mão Esquerda — ASDF',
        desc: 'Dedinho em A, anelar em S, médio em D, indicador em F. Pratique só a mão esquerda.',
        keys: ['a','s','d','f'],
        homeKeys: ['a','s','d','f'],
        text: 'aaa sss ddd fff aaa sss ddd fff asd fds sad fas daf sdf fda sfa daf fas sdf aaa fff ddd sss asdf fdsa sadf dsaf',
        xp: 50,
      ...
      },
      {
        ...
        num: 2,
        icon: '🤚',
        title: 'Mão Direita — JKLÇ',
        desc: 'Indicador em J, médio em K, anelar em L, dedinho em Ç. Pratique só a mão direita.',
        keys: ['j','k','l',';'],
        homeKeys: ['j','k','l'],
        text: 'jjj kkk lll jjj kkk lll jkl lkj kjl jlk lkj kjl jjj lll kkk jkl lkj jlk kjl jkl lkj kjl jkl lkj',
        xp: 50,
        tip: 'Sinta as marcas em F e J — elas indicam a posição home sem precisar olhar para o teclado.'
      },
      {
        id: 'b3',
        num: 3,
        ...
        desc: 'Agora combine as duas mãos na posição home. Pratique alternando entre elas com ritmo.',
        keys: ['a','s','d','f','j','k','l'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'asdf jkl fads lkj sdf jkl adf jlk dsa klj fja skd lad fkj sdf jkl asdf jkl fdsa lkj asdf jkl',
        xp: 75,
        tip: 'Alterne as mãos de forma rítmica. Isso é a base de uma boa digitação profissional.'
      },
      {
        id: 'b4',
        num: 4,
        icon: '⬆️',
        title: 'Teclas GH — Centro do Teclado',
        desc: 'G e H ficam no centro. O indicador esquerdo alcança G saindo de F, e o direito alcança H saindo de J.',
        keys: ['g','h'],
        homeKeys: ['f','j'],
        text: 'ggg hhh ghg hgh ggh hhg ghh ggh fgh jhk gah hag gfh jhk ghj hgf asg jhk dfg lkh asdfgh jklhg',
        xp: 60,
        tip: 'Após pressionar G ou H, retorne imediatamente os dedos para F e J.'
      },
      {
        id: 'b5',
        num: 5,
        icon: '⬆️',
        title: 'Fileira Superior — QWE / UIO',
        desc: 'Mova os dedos para cima a partir da posição home. Retorne sempre após cada tecla.',
        keys: ['q','w','e','u','i','o'],
        homeKeys: ['a','s','d','j','k','l'],
        text: 'que owi woe ieu qui oew uio qwe owe uiq oiq eqo iuw qoi euw oiw eqw iou wue qio quei ouiw',
        xp: 80,
      ...
      },
      {
        ...
        num: 6,
        icon: '⬆️',
        title: 'Fileira Superior — RT / YU',
        desc: 'R e T são alcançados pelo indicador esquerdo. Y e U pelo indicador direito.',
        keys: ['r','t','y','u'],
        homeKeys: ['f','j'],
        text: 'rrt tty yyu urt try yur rty uyt ryu tyr yut rtu ytr uyr tyr ryu tuy ryt yur tru erty yuio',
        xp: 80,
        tip: 'Estique o indicador para cima sem mover o pulso. Retorne à posição home após cada tecla.'
      },
      {
        id: 'b7',
        num: 7,
        icon: '⬇️',
        title: 'Fileira Inferior — ZXCV / NM',
        desc: 'Flexione os dedos para baixo a partir da posição home. Z usa o dedinho esquerdo.',
        keys: ['z','x','c','v','n','m'],
        homeKeys: ['a','s','d','f','j','k'],
        text: 'zzz xxx ccc vvv nnn mmm znm vxc cxz nmv vcx mnz xzc vnm cxz vmn zxc nmv cxz mnv zxcv nm',
        xp: 80,
        tip: 'Não levante os pulsos ao acessar a fileira inferior. Flexione apenas os dedos.'
      },
      {
        id: 'b8',
        num: 8,
        ...
        desc: 'Pratique as primeiras palavras reais usando todas as letras aprendidas.',
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'sol lua mar rio voz mao dia cor luz noz asa mel fel cal mal sal ala ela ola ali ame amo ave',
        xp: 100,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'casa sala mesa vela faca cola mala bola cama roda moda soda toda boca loca foca roca poda',
        xp: 100,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'asdf jkl casa sala mesa faca bola vela mala roda soda cola moda dia sol lua mar rio voz cor luz',
        xp: 150,
    ...
    lessons: [
      {
        ...
        keys: ['A','S','D','F','J','K','L'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'Ana Sol Lua Mar Rio Dia Cor Luz Asa Mel Sal Ala Ela Ola Ali Ame Jose Maria Pedro Carlos Silva',
        xp: 80,
      ...
      },
      {
        ...
        num: 2,
        icon: '🔤',
        title: 'Vogais com Acento',
        desc: 'Pratique as vogais acentuadas comuns no português: á, é, í, ó, ú, ã, õ.',
        keys: ['á','é','í','ó','ú','ã','õ'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'acao nacao funcao atencao condicao missao botoes maos pao nao sao cao mao vao rao tao sao',
        xp: 90,
        tip: 'No teclado ABNT, os acentos ficam próximos às teclas da mão direita.'
      },
      {
        id: 'i3',
        num: 3,
      ...
      },
      {
        ...
        keys: ['.', ',', ':', ';'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'Ola mundo. Como vai? Tudo bem. Nome: Maria. Data: hoje. Lista: um dois tres quatro cinco.',
        xp: 90,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'O computador e uma ferramenta essencial no trabalho moderno. Salve seus arquivos regularmente.',
        xp: 110,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'relatorio reuniao proposta cliente contrato prazo orcamento projeto equipe resultado analise',
        xp: 110,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'A tecnologia transformou o mercado de trabalho. Saber digitar com velocidade e precisao e um diferencial. Pratique diariamente e evolua suas habilidades profissionais.',
        xp: 200,
    ...
    lessons: [
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'A inteligencia artificial esta revolucionando diversos setores da economia global desde saude ate educacao e logistica.',
        xp: 150,
      ...
      },
      {
        ...
        desc: 'Termos e palavras-chave usados em programação.',
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'Redes de computadores permitem o compartilhamento de recursos e informacoes entre dispositivos conectados por meio de protocolos de comunicacao padronizados.',
        xp: 170,
        tip: 'Textos técnicos têm vocabulário específico. Quanto mais você pratica, mais familiar fica.'
      },
      {
        id: 'a4',
        num: 4,
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'A seguranca da informacao protege dados contra acessos nao autorizados. Senhas fortes e autenticacao em dois fatores sao praticas essenciais para qualquer profissional.',
        xp: 170,
        tip: 'Palavras compostas precisam de atenção especial. Não acelere demais nelas.'
      },
      {
        id: 'a5',
        num: 5,
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'O aprendizado de maquina permite que sistemas computacionais aprendam padroes a partir de dados sem serem explicitamente programados para cada tarefa especifica.',
        xp: 180,
      ...
      },
      {
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'A transformacao digital esta redefinindo a forma como empresas operam e se relacionam com clientes. Profissionais que dominam ferramentas tecnologicas e digitam com agilidade possuem vantagem competitiva significativa no mercado de trabalho atual.',
        xp: 300,
  ...
  numeros: {
    ...
    lessons: [
      ...
      },
      {
        ...
        xp: 70,
        tip: 'Use os quatro dedos e estique para as teclas distantes. O polegar não é usado nos números.'
      },
      {
        id: 'n3',
        num: 3,
      ...
      },
      {
        ...
        desc: 'Pratique digitação de valores financeiros com separadores decimais.',
        keys: ['R','$','.', ','],
        homeKeys: ['a','s','d','f','j','k','l'],
      ...
      },
      {
        ...
        desc: 'Formatos comuns de documentos: telefones, CEP e datas.',
        keys: ['(',')','-','/'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: '(65) 3322-1100 (11) 99999-0000 78305-000 79000-000 01/01/2025 31/12/2024 15/06/2025',
        xp: 110,
        tip: 'Parênteses, hífens e barras são muito usados em formulários. Pratique sem olhar o teclado.'
      },
      {
        id: 'n6',
        num: 6,
        ...
        keys: ['@','#','%','&','*','_'],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'email@dominio.com.br usuario@empresa.net #tecnologia #informatica 50% 100% user_name config_file',
        xp: 120,
        tip: 'O @ é essencial para e-mails. O _ é muito usado em programação e nomes de arquivos.'
      },
      {
        id: 'n7',
        num: 7,
        ...
        keys: [],
        homeKeys: ['a','s','d','f','j','k','l'],
        text: 'Pedido 1234 Cliente Joao Silva Tel (65) 99999-0000 Valor R$ 1.500,00 Venc 31/01/2025',
        xp: 200,
...
function startLesson(levelKey, lessonId) {
  ...
  navigateTo('practice');
  showToast(`📖 Lição ${lesson.num}: ${lesson.title} — Iniciada!`);
}
...
function checkLessonCompletion(wpm, accuracy) {
  ...
  showToast(`🏆 Lição ${lesson.num} concluída! ${wpm} WPM — ${accuracy}% precisão`);
  clearActiveLesson();
...
function renderLessonCard(lesson, idx, levelKey, progress) {
  ...
  const bestDisplay  = best ? `<div class="lesson-best">✓ Melhor: ${best.wpm} WPM · ${best.accuracy}%</div>` : '';

  const clickAction = unlocked ? `startLesson('${levelKey}','${lesson.id}')` : '';

  return `
    <div class="lesson-card ${cardClass}" onclick="${clickAction}">
      <div class="lesson-num">
        <span>LIÇÃO ${lesson.num} ${introTag}${challengeTag}</span>
        <span class="lesson-badge-icon">${lesson.icon}${done ? ' ✅' : ''}</span>
      </div>
      <h3>${lesson.title}</h3>
      <p>${lesson.desc}</p>
      ...
      <div class="lesson-footer">
        ...
        <button class="lesson-play-btn ${btnClass}"
          onclick="event.stopPropagation();${clickAction}">${btnText}</button>
      </div>
...
function checkWelcome() {
  const hide = localStorage.getItem('digimaster_hide_welcome');
  if (!hide) {
...
function saveDontShow(checked) {
  if (checked) localStorage.setItem('digimaster_hide_welcome', '1');
  else localStorage.removeItem('digimaster_hide_welcome');
}
